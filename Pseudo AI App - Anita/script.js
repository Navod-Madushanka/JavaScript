...
if (speechRecognition && speechSynthesis) {
    ...
    //         }
    //     }, 3000)
    //  Start speech recognotion shortcuts
    speechRecognotionKeys();
    loadTranscript();
} else {
...
// Speech Recognotion shortcuts function
function speechRecognotionKeys() {
    ...
    recognition.addEventListener("result", (e) => {
        ...
        for (let i = 0; i < lists.length; i++) {
            ...
            if (askedQuestion.startsWith("what is", 0) && askedQuestion !== lists[i].question && (i = 1)) {
                ...
                let errorMsg = "I am sorry, I do not have enough data to answer this question this time";
                respond(errorMsg);
                break;
            }
        }
